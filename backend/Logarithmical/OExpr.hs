...
-- TODO: make OExpr isorecursive type like `Fix OExprShape` or a tahless final interpreter to
-- remove boilerplate

-- Represent how loop variant is variated on each loop iteration
data OCounterVariant = OIncrenmentCounter deriving (Eq, Show, Read, Ord)
